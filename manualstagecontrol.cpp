...
void ManualStageControl::on_MoveRelative_clicked()
{
    ...
    QString RelativeMoveString = "Relative Move: " + QString::number(RelativeMoveDistance) + "μm";
...
void ManualStageControl::on_MoveAbsolute_clicked()
{
    ...
    QString AbsoluteMoveString = "Absolute Move: " + QString::number(AbsoluteMoveDistance) + "μm";
...
void ManualStageControl::on_SetMinEndOfRun_clicked()
{
    ...
    ui->TerminalOut->append("MinEndOfRun: " + MinEndOfRunString + "μm");
...
void ManualStageControl::on_SetMaxEndOfRun_clicked()
{
    ...
    ui->TerminalOut->append("MaxEndOfRun: " + MaxEndOfRunString + "μm");
...
void ManualStageControl::on_SetAcceleration_clicked()
{
    ...
    ui->TerminalOut->append("Set Acceleration: " + AccelerationString + "mm/s");
